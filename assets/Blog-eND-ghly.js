import{f as k,j as e,L as l,r as w}from"./react-vendor-Dt1bpZnz.js";import{L as p}from"./index-CpLYVRtO.js";import"./i18n-D0AEmD6X.js";const T=new Set("the a an and or of to in for your you how what is are be on with that this it as at by from across into not but new — your guide complete".split(" "));function m(r){return new Set(`${r.title} ${r.summary}`.toLowerCase().replace(/[^a-z0-9 ]/g," ").split(/\s+/).filter(o=>o.length>3&&!T.has(o)))}function A(r,o=3){const i=y.findIndex(t=>t.slug===r);if(i<0)return y.slice(0,o);const a=m(y[i]);return y.map((t,n)=>{if(n===i)return null;const s=m(t);let c=0;for(const d of s)a.has(d)&&c++;return{p:t,overlap:c,i:n}}).filter(Boolean).sort((t,n)=>n.overlap-t.overlap||t.i-n.i).slice(0,o).map(t=>t.p)}const y=[{slug:"how-to-track-crypto-portfolio-free",title:"How to Track Your Crypto Portfolio for Free in 2026",date:"May 2026",readTime:"5 min read",summary:"A complete guide to tracking Bitcoin, Ethereum, and altcoin holdings without paying for a subscription or giving up your private keys.",content:`
...
Track NVIDIA, Apple, Bitcoin, and every asset in one free dashboard at [walletlens.live](https://walletlens.live) — no account needed.
    `},{slug:"what-is-roi-investing",title:"What Is ROI in Investing? (And How to Calculate It for Crypto, Stocks, and Gold)",date:"June 2026",readTime:"5 min read",summary:"ROI explained — the formula, what it means for different asset types, its limitations, and how to calculate it instantly.",content:`
...
For a complete multi-asset net worth view without connecting any accounts, [walletlens.live](https://walletlens.live) remains the best free option — covering every asset class in one place, with your data stored only on your device. No account, no bank login, no sign-up.
    `}],f="https://walletlens.live";function x(r){w.useEffect(()=>{const o=document.title,i=(s,c,d)=>{let h=document.head.querySelector(s);return h||(h=document.createElement(s.startsWith("link")?"link":"meta"),s.startsWith("link")?h.setAttribute("rel","canonical"):s.includes("property=")?h.setAttribute("property",s.match(/property="([^"]+)"/)[1]):h.setAttribute("name",s.match(/name="([^"]+)"/)[1]),document.head.appendChild(h)),h.setAttribute(c,d),h},a=r?`${f}/blog/${r.slug}`:`${f}/blog`,t=r?`${r.title} | WalletLens`:"Blog — Portfolio Tracking, Crypto Investing & Market Analysis | WalletLens",n=r?r.summary:"Free guides on tracking your crypto, stocks and gold portfolio, reading whale transactions, the Fear & Greed Index, diversification, and setting profit targets.";return document.title=t,i('meta[name="description"]',"content",n),i('link[rel="canonical"]',"href",a),i('meta[property="og:title"]',"content",t),i('meta[property="og:description"]',"content",n),i('meta[property="og:url"]',"content",a),i('meta[name="twitter:title"]',"content",t),i('meta[name="twitter:description"]',"content",n),()=>{document.title=o}},[r])}function I(r,o){const i=r.trim().split(`
`);for(const a of i){const t=a.trim();if(t&&!t.startsWith("#")&&!t.startsWith("-")&&!t.startsWith("|")&&!t.startsWith(">")&&t.length>40){const n=t.replace(/\*\*([^*]+)\*\*/g,"$1").replace(/\[([^\]]+)\]\([^)]+\)/g,"$1");return n.length>o?n.slice(0,o-1)+"…":n}}return""}function C(r,o){const i=r.content.trim().split(`
`),a=[];for(const t of i)if(t.startsWith("## "))a.push(`
`+t.slice(3).toUpperCase()+`
`);else if(t.startsWith("### "))a.push(`
`+t.slice(4)+`
`);else if(t.startsWith("> "))a.push(t.slice(2).replace(/\*\*([^*]+)\*\*/g,"$1").replace(/\[([^\]]+)\]\([^)]+\)/g,"$1"));else if(t.startsWith("- "))a.push("• "+t.slice(2).replace(/\*\*([^*]+)\*\*/g,"$1").replace(/\[([^\]]+)\]\([^)]+\)/g,"$1"));else if(/^\d+\. /.test(t))a.push(t.replace(/\*\*([^*]+)\*\*/g,"$1").replace(/\[([^\]]+)\]\([^)]+\)/g,"$1"));else if(!(t.startsWith("| ")||t.startsWith("|---")))if(t.startsWith("**")&&t.endsWith("**"))a.push(`
`+t.slice(2,-2)+`
`);else{const n=t.replace(/\*\*([^*]+)\*\*/g,"$1").replace(/\[([^\]]+)\]\([^)]+\)/g,"$1");a.push(n)}return`${r.title}
...
— Read on WalletLens: ${o}`}function S({post:r}){const[o,i]=w.useState(!1),a=`https://walletlens.live/blog/${r.slug}`,t=I(r.content,180-r.title.length),n=encodeURIComponent(`${r.title}

${t}

${a}`);function s(d){d.preventDefault();const h=`twitter://post?message=${n}`,v=`https://x.com/intent/post?text=${n}`,b=setTimeout(()=>{window.open(v,"_blank","noopener,noreferrer")},1500),g=()=>clearTimeout(b);window.addEventListener("blur",g,{once:!0}),window.addEventListener("pagehide",g,{once:!0}),window.location.href=h}function c(){const d=C(r,a);navigator.clipboard.writeText(d).then(()=>{i(!0),setTimeout(()=>i(!1),8e3)})}return e.jsxs("div",{className:"blog-share-bar",children:[e.jsx("span",{className:"blog-share-label",children:"Share"}),e.jsxs("a",{className:"blog-share-btn blog-share-x",href:`https://x.com/intent/post?text=${n}`,onClick:s,"aria-label":"Share on X",children:[e.jsx("svg",{width:"15",height:"15",viewBox:"0 0 24 24",fill:"currentColor",children:e.jsx("path",{d:"M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-4.714-6.231-5.401 6.231H2.746l7.73-8.835L1.254 2.25H8.08l4.259 5.63L18.244 2.25zm-1.161 17.52h1.833L7.084 4.126H5.117z"})}),"Post on X"]}),e.jsxs("button",{className:"blog-share-btn blog-share-article",onClick:c,"aria-label":"Copy full article text for an X Article",children:[e.jsxs("svg",{width:"15",height:"15",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2",strokeLinecap:"round",strokeLinejoin:"round",children:[e.jsx("path",{d:"M4 6h16M4 10h16M4 14h10"}),e.jsx("circle",{cx:"19",cy:"17",r:"3"}),e.jsx("path",{d:"m21.5 19.5-1.5-1.5"})]}),o?"Article copied ✓":"Copy full article"]}),o&&e.jsxs("p",{className:"blog-share-hint",children:["Full article copied. On X (desktop, Premium+ required): open the"," ",e.jsx("strong",{children:"Articles"})," tab in the sidebar → ",e.jsx("strong",{children:"Write"})," → paste with Ctrl/⌘+V."," ","X Articles can't be created in the mobile app."]})]})}function W({post:r}){return e.jsxs(l,{to:`/blog/${r.slug}`,className:"blog-card",children:[e.jsxs("div",{className:"blog-card-meta",children:[r.date," · ",r.readTime]}),e.jsx("h2",{className:"blog-card-title",children:r.title}),e.jsx("p",{className:"blog-card-summary",children:r.summary}),e.jsx("span",{className:"blog-card-cta",children:"Read article →"})]})}function P({slug:r}){const o=A(r,3);return o.length?e.jsxs("nav",{className:"blog-related","aria-label":"Related articles",children:[e.jsx("h2",{className:"blog-related-title",children:"Keep reading"}),e.jsx("div",{className:"blog-related-grid",children:o.map(i=>e.jsxs(l,{to:`/blog/${i.slug}`,className:"blog-related-card",children:[e.jsx("span",{className:"blog-related-meta",children:i.readTime}),e.jsx("span",{className:"blog-related-name",children:i.title}),e.jsx("span",{className:"blog-related-cta",children:"Read →"})]},i.slug))})]}):null}function u(r){const o=[],i=/\*\*([^*]+)\*\*|\[([^\]]+)\]\((https?:\/\/[^)]+|\/[^)]*)\)/g;let a=0,t;for(;(t=i.exec(r))!==null;)t.index>a&&o.push(r.slice(a,t.index)),t[1]!=null?o.push(e.jsx("strong",{children:t[1]},t.index)):t[3].startsWith("http")?o.push(e.jsx("a",{href:t[3],target:"_blank",rel:"noopener noreferrer",style:{color:"var(--g-ink)"},children:t[2]},t.index)):o.push(e.jsx(l,{to:t[3],style:{color:"var(--g-ink)"},children:t[2]},t.index)),a=t.index+t[0].length;return a<r.length&&o.push(r.slice(a)),o}function B(r){const o=r.trim().split(`
`),i=[];let a=0;for(;a<o.length;){const t=o[a];if(t.startsWith("## "))i.push(e.jsx("h2",{children:u(t.slice(3))},a));else if(t.startsWith("### "))i.push(e.jsx("h3",{children:u(t.slice(4))},a));else if(t.startsWith("**")&&t.endsWith("**"))i.push(e.jsx("p",{children:e.jsx("strong",{children:t.slice(2,-2)})},a));else if(t.startsWith("> "))i.push(e.jsx("blockquote",{style:{borderLeft:"3px solid var(--g-ink)",paddingLeft:"1rem",margin:"1rem 0",opacity:.8},children:u(t.slice(2))},a));else if(t.startsWith("- ")){const n=[];for(;a<o.length&&o[a].startsWith("- ");)n.push(e.jsx("li",{children:u(o[a].slice(2))},a)),a++;i.push(e.jsx("ul",{children:n},"ul"+a));continue}else if(/^\d+\. /.test(t)){const n=[];for(;a<o.length&&/^\d+\. /.test(o[a]);)n.push(e.jsx("li",{children:u(o[a].replace(/^\d+\. /,""))},a)),a++;i.push(e.jsx("ol",{children:n},"ol"+a));continue}else if(t.startsWith("| ")){const n=[];for(;a<o.length&&o[a].startsWith("| ");){if(!o[a].includes("---")){const s=o[a].split("|").filter(c=>c.trim());n.push(s)}a++}i.push(e.jsxs("table",{className:"blog-table",children:[e.jsx("thead",{children:e.jsx("tr",{children:n[0].map((s,c)=>e.jsx("th",{children:s.trim()},c))})}),e.jsx("tbody",{children:n.slice(1).map((s,c)=>e.jsx("tr",{children:s.map((d,h)=>e.jsx("td",{children:d.trim()},h))},c))})]},"tbl"+a));continue}else t.trim()!==""&&i.push(e.jsx("p",{children:u(t)},a));a++}return i}function M(){const{slug:r}=k(),o=r?y.find(i=>i.slug===r):null;return x(o),r&&!o?e.jsxs("div",{className:"doc-page",children:[e.jsx("header",{className:"doc-header",children:e.jsxs(l,{to:"/",className:"doc-brand",children:[e.jsx(p,{size:26})," WalletLens"]})}),e.jsxs("article",{className:"doc-article",children:[e.jsx("h1",{children:"Post not found"}),e.jsx(l,{to:"/blog",children:"← Back to Blog"})]})]}):o?e.jsxs("div",{className:"doc-page",children:[e.jsx("header",{className:"doc-header",children:e.jsxs(l,{to:"/",className:"doc-brand",children:[e.jsx(p,{size:26})," WalletLens"]})}),e.jsxs("article",{className:"doc-article",children:[e.jsx(l,{to:"/blog",className:"blog-back",children:"← All Articles"}),e.jsxs("p",{className:"doc-meta",children:[o.date," · ",o.readTime]}),e.jsx("h1",{children:o.title}),e.jsx("p",{className:"blog-summary",children:o.summary}),e.jsx("hr",{className:"blog-divider"}),B(o.content),e.jsx("hr",{className:"blog-divider"}),e.jsx(S,{post:o}),e.jsxs("div",{className:"blog-cta-box",children:[e.jsx("strong",{children:"Start tracking your portfolio for free"}),e.jsx("p",{children:"WalletLens is 100% free, no account required, and all your data stays on your device."}),e.jsx(l,{to:"/dashboard",className:"blog-cta-btn",children:"Open WalletLens →"})]}),e.jsx(P,{slug:o.slug})]}),e.jsxs("footer",{className:"doc-footer",children:[e.jsx(l,{to:"/blog",children:"← All Articles"}),e.jsx(l,{to:"/",children:"Home"}),e.jsx(l,{to:"/privacy",children:"Privacy Policy"})]})]}):e.jsxs("div",{className:"doc-page",children:[e.jsx("header",{className:"doc-header",children:e.jsxs(l,{to:"/",className:"doc-brand",children:[e.jsx(p,{size:26})," WalletLens"]})}),e.jsxs("div",{className:"doc-article",children:[e.jsx("h1",{children:"WalletLens Blog"}),e.jsx("p",{className:"doc-meta",children:"Guides and insights on portfolio tracking, crypto investing, and market analysis."}),e.jsx("div",{className:"blog-grid",children:y.map(i=>e.jsx(W,{post:i},i.slug))})]}),e.jsxs("footer",{className:"doc-footer",children:[e.jsx(l,{to:"/",children:"← Back to WalletLens"}),e.jsx(l,{to:"/about",children:"About"}),e.jsx(l,{to:"/privacy",children:"Privacy Policy"})]})]})}export{M as default};
