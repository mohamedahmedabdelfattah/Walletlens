import{f as h,a as u,r as g,j as e,L as n}from"./react-vendor-Dt1bpZnz.js";import{t as l,L as y}from"./index-CpLYVRtO.js";import"./i18n-D0AEmD6X.js";const c=[{slug:"cost-basis",term:"Cost Basis",short:"Cost basis is the total amount you originally paid to acquire an asset, including fees, used to calculate your profit or loss when you sell.",body:`Cost basis is the original value of an asset for tax and tracking purposes. It is usually the purchase price plus any commissions or fees you paid to acquire it.
...
Your asset allocation should match your risk tolerance: more aggressive if you can handle big swings, more conservative if you cannot. Reassess it as your circumstances and goals change over time.`,related:["asset-allocation","volatility","diversification"]}],p=i=>c.find(s=>s.slug===i),m=e.jsx("svg",{width:"18",height:"18",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2.5",strokeLinecap:"round",children:e.jsx("path",{d:"M5 12h14M12 5l7 7-7 7"})});function w(){const{slug:i}=h(),s=u(),t=p(i);if(g.useEffect(()=>{t?(l("learn_view",{slug:i}),document.title=`What Is ${t.term}? — WalletLens`):s("/dashboard",{replace:!0})},[t,s,i]),!t)return null;const d=t.body.split(`

`),r=(t.related||[]).map(a=>c.find(o=>o.slug===a)).filter(Boolean);return e.jsx("div",{className:"wl-app wl-app-landing",children:e.jsxs("main",{className:"tc-page",children:[e.jsx("header",{className:"tc-head",children:e.jsxs(n,{to:"/",className:"tc-brand","aria-label":"WalletLens home",children:[e.jsx(y,{size:34})," ",e.jsx("span",{children:"WalletLens"})]})}),e.jsxs("section",{className:"tc-hero",children:[e.jsxs("h1",{className:"tc-h1",children:["What Is ",t.term,"?"]}),e.jsx("p",{className:"tc-sub",children:t.short})]}),e.jsxs("section",{className:"tc-section",children:[e.jsx("h2",{children:"Definition"}),d.map((a,o)=>e.jsx("p",{children:a},o))]}),e.jsxs("section",{className:"tc-section",children:[e.jsx("h2",{children:"Track it in WalletLens"}),e.jsx("p",{children:"WalletLens is a free, private net-worth tracker that puts concepts like this into practice — it tracks your crypto, stocks, gold and cash in one dashboard, computing your cost basis, P&L and allocation automatically with live prices. No account, no sign-up, and your data stays on your device."}),e.jsxs("button",{className:"lp-cta-primary",style:{marginTop:"0.9rem"},onClick:()=>{l("learn_cta",{slug:i}),s("/dashboard")},children:["Open free tracker",m]})]}),r.length>0&&e.jsxs("section",{className:"tc-section",children:[e.jsx("h2",{children:"Related terms"}),e.jsx("ul",{className:"tc-list",children:r.map(a=>e.jsx("li",{children:e.jsx(n,{to:`/learn/${a.slug}`,children:a.term})},a.slug))})]}),e.jsxs("footer",{className:"tc-foot",children:[e.jsx(n,{to:"/free-net-worth-tracker",children:"Free net worth tracker"}),e.jsx("span",{children:"·"}),e.jsx(n,{to:"/blog",children:"Blog"}),e.jsx("span",{children:"·"}),e.jsx(n,{to:"/about",children:"About"}),e.jsx("span",{children:"·"}),e.jsx(n,{to:"/",children:"Home"})]})]})})}export{w as default};
